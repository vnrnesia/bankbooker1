...
const Brands = () => {
    return (
        <div className="px-4 font-[Manrope] max-w-10/12 mx-auto pt-24 text-center">
                ...
                {icons.map((icon, index) => (
                    ...
                    >
                        <Image
                            ...
                            width={150}
                            height={60}
                            className={`object-contain grayscale group-hover:grayscale-0 group-hover:scale-105 transition duration-300 ease-in-out ${index === 4 ? "w-[80%] md:w-[45%]" : "w-[100%] md:w-[65%]"
                                }`}
                        />
                    </div>
                ))}
